...
const images = [
  ...
  { src: "/assets/Images/gallery/pic1.webp", alt: "Project5" },
  { src: "/assets/Images/gallery/pic2.jpg", alt: "Project6" },
];
      ...
      <div className="gallery-section">
        {images.map((image, index) => (
          <div className="card" key={index}>
            <img src={image.src} className="card-img" alt={image.alt} loading="lazy" />
          </div>
        ))}
      </div>
    </div>
